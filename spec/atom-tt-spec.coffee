...
describe "AtomTt", ->
  ...
  describe "when the atom-tt:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      # has been created
      expect(workspaceElement.querySelector('.atom-tt')).not.toExist()
      ...
      runs ->
        expect(workspaceElement.querySelector('.atom-tt')).toExist()

        atomTtElement = workspaceElement.querySelector('.atom-tt')
        expect(atomTtElement).toExist()

        atomTtPanel = atom.workspace.panelForItem(atomTtElement)
